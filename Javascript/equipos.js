...
// const obteniendoLaptop = (ObtenerLaptop)=> {
//     baseDeDatos.collection("imagenes").onSnapshot(ObtenerLaptop);
             ...
             (listaDeImagenes)=>{
                 galeria.innerHTML=``;
                    listaDeImagenes.forEach(
                        (imagen) => {
                            galeria.innerHTML = `<img src=https://firebasestorage.googleapis.com/v0/b/jjcss-tech-dff98.appspot.com/o/pc%20gamer%20sin%20fondo.png?alt=media&token=de2f8b75-4de0-4205-82c6-5ab147238931 width="400px" height="300px"/>`;
                        }
                    )
             }
         )
            ...
            obteniendoImagenes(
                (listaDeImagenes)=>{
                    Laptop.innerHTML=``;
                       listaDeImagenes.forEach(
                           (imagen) => {
                               Laptop.innerHTML = `<img src=https://firebasestorage.googleapis.com/v0/b/jjcss-tech-dff98.appspot.com/o/laptops%20sin%20fondo.png?alt=media&token=6bd395a6-b40b-4e01-8141-7bd1f15d161f width="400px" height="300px"/>`;
                           }
                       )
                }
            )
